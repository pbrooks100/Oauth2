...
<Library LVVersion="13008000">
	...
	<Item Name="Compute SHA256 (byte array).vi" Type="VI" URL="../Compute SHA256 (byte array).vi"/>
	<Item Name="Compute SHA256 (string).vi" Type="VI" URL="../Compute SHA256 (string).vi"/>
	<Item Name="NI_SHA-256.lvclass" Type="LVClass" URL="../NI_SHA-256.lvclass"/>
</Library>
